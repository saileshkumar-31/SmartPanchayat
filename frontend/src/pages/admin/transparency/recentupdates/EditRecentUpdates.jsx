...
export default function EditRecentUpdate() {

  // Dynamic State
  const [title, setTitle] =
    useState("Road Construction Phase 2 Started");
  ...
  const [summary, setSummary] =
    useState(
      "Road expansion and drainage construction works officially started in Ward 3."
    );

  const [content, setContent] =
    useState(
      "The Panchayat administration has initiated phase 2 road construction works including drainage and pedestrian pathways for public infrastructure development."
    );

  const [author, setAuthor] =
    useState("Panchayat Administration");
      ...
      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 mb-10">
        ...
        <div>
          ...
          <p className="text-gray-500 text-lg max-w-3xl">
            Modify Panchayat announcements,
            public notices, and citizen transparency communications.
          </p>
        </div>
          ...
          <div className="flex items-center justify-between mb-10">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-2">
                Edit public update and announcement details.
              </p>
            </div>
          ...
          <div className="mt-10">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-3xl p-8 bg-[#fafafa] flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-500 mt-2 text-sm">
                Upload banners, notices, or update documents.
              </p>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    Citizens can instantly access published updates.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    Public communication syncs automatically.
                  </p>
                </div>
              </div>
            </div>
