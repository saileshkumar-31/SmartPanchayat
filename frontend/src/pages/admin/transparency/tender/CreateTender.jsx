      ...
      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 mb-10">
        ...
        <div>
          ...
          <p className="text-gray-500 text-lg max-w-3xl">
            Create Panchayat procurement tenders,
            contractor bidding records, and public transparency documents.
          </p>
        </div>
          ...
          <div className="flex items-center justify-between mb-10">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-2">
                Fill all required tender and procurement details.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="h-16 rounded-2xl border border-gray-200 px-5 flex items-center gap-4 bg-[#fafafa]">
                ...
                <input
                  ...
                  placeholder="Road Construction Tender"
          ...
          <div className="mt-10">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-3xl p-8 bg-[#fafafa] flex flex-col items-center justify-center text-center">
              ...
              <p className="text-gray-500 mt-2 text-sm">
                Upload procurement PDFs and bidding files.
              </p>
          ...
          <div className="mt-10">
            ...
            <div className="rounded-3xl border border-gray-200 bg-[#fafafa] p-5">
              ...
              <textarea
                ...
                placeholder="Write procurement notes, bidding details, or administrative remarks..."
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    Tender details are being prepared.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">
                    Workflow updates instantly while editing.
                  </p>
                </div>
              </div>
            </div>
