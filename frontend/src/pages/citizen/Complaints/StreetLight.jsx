...
const Streetlight = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await submitComplaint("Street Light", formData);
      alert(`Street light complaint submitted. Reference: ${res.data.reference_no}`);
    } catch (error) {
      alert(error.message);
    }
  };
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Report damaged, flickering, or non-working street lights.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <option>Cement Pole</option>
              <option>Metal Pole</option>
          ...
          <div>
            ...
            >
              ...
              <option>Wire Damage</option>
              <option>Light Always ON</option>
              <option>Other</option>
            </select>
          </div>
