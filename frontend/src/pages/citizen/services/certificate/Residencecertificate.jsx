...
const navigate = useNavigate();
  const documents = [
    ...
    "Rental Agreement / House Tax Receipt",
  ...
  const eligibility = [
    "Applicant should currently reside at the stated address.",
    "Residence details may be verified by local authority.",
    "Supporting address documents should match submitted details.",
  ];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 max-w-3xl">
                Residence Certificate is used as proof of present address for
                admissions, employment, banking, legal procedures and other
                official purposes.
              </p>
            </div>
            ...
            <div className="bg-[#f6faf6] rounded-xl border border-gray-100 p-6 min-w-[280px]">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Depends on local verification and authority approval.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
            ...
            <p className="text-sm text-gray-500 mt-5">
              Exact requirements may vary based on district or issuing authority.
            </p>
          </div>
