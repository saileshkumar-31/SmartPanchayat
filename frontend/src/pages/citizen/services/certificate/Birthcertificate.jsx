...
const BirthCertificate = () => {
  ...
  const documents = [
    "Hospital Birth Record / Birth Report",
    "Child Name Details (if naming completed)",
    "Parents Aadhaar Cards",
    "Parents Marriage Proof (if available)",
    "Address Proof",
    "Discharge Summary / Medical Record",
    "Passport Size Photograph of Parents (if required)",
    "Delayed Registration Affidavit (if applicable)",
  ];
  const Navigate = useNavigate();

  const eligibility = [
    "Birth should be registered as per applicable registration rules.",
    "Applicant should be parent / guardian / authorized person.",
    "Supporting records should match birth details submitted.",
  ];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 max-w-3xl">
                Birth Certificate is an official record of birth used for
                school admission, passport, Aadhaar, inheritance, and many
                other legal or identity purposes.
              </p>
            </div>
