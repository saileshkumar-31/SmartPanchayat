...
const navigate = useNavigate();
  const documents = [
    ...
    "Address Proof",
    "School Transfer Certificate / Study Certificate (if available)",
    "Parent / Family Community Proof (if available)",
    "Passport Size Photograph",
    "Self Declaration / Affidavit if required",
  ];

  const eligibility = [
    "Applicant should belong to the claimed community category.",
    "Applicant should be a resident of the state.",
    "Supporting records may be verified by the competent authority.",
  ];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 max-w-3xl">
                Community Certificate is commonly used for reservation benefits,
                scholarships, education admissions, employment applications,
                and welfare scheme eligibility.
              </p>
            </div>
            ...
            <div className="bg-[#f6faf6] rounded-xl border border-gray-100 p-6 min-w-[280px]">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Depends on field verification and authority approval.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
            ...
            <p className="text-sm text-gray-500 mt-5">
              Exact document requirements can vary based on district or authority review.
            </p>
          </div>
