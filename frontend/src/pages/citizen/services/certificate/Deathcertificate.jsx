...
const navigate = useNavigate();
  const documents = [
    "Hospital Death Report / Medical Certificate of Cause of Death",
    "Deceased Person Aadhaar Card (if available)",
    "Applicant Aadhaar Card",
    "Relationship Proof / Legal Heir Proof (if required)",
    "Address Proof",
    "Burial / Cremation Record (if applicable)",
    "Passport Size Photograph of Applicant (if required)",
    "Delayed Registration Affidavit (if applicable)",
  ];

  const eligibility = [
    "Death should be registered as per applicable registration rules.",
    "Applicant should be family member, legal representative, or authorized person.",
    "Submitted records should match official death details.",
  ];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 max-w-3xl">
                Death Certificate is an official record used for legal claims,
                insurance, pension transfer, inheritance matters, bank closure,
            ...
            <div className="bg-[#f6faf6] rounded-xl border border-gray-100 p-6 min-w-[280px]">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Delayed registrations may require additional approval.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
            ...
            <p className="text-sm text-gray-500 mt-5">
              Exact requirements may vary depending on registration timing and authority.
            </p>
          </div>
