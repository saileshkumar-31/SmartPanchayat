    ...
    <footer className="bg-[#0b5e22] text-white mt-10">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          <div
            onClick={() => navigate("/")}
            className="flex items-center gap-3 mb-3 justify-center sm:justify-start cursor-pointer"
          >
            <img
              src={logo}
              alt="Smart Panchayat"
        ...
        <div className="text-center sm:text-left">
          ...
          <div className="flex gap-3 justify-center sm:justify-start flex-wrap">
            ...
            >
              <img src={fb} alt="Facebook" className="w-7 h-7 object-contain" />
            </a>
            ...
            <a
              ...
              className="w-10 h-10 rounded-full flex items-center justify-center hover:scale-110 transition"
            >
              <img src={tw} alt="Twitter" className="w-5 h-5 object-contain" />
            </a>
            ...
            <a
              ...
              className="w-10 h-10 rounded-full flex items-center justify-center hover:scale-110 transition"
            >
              <img src={yt} alt="YouTube" className="w-5 h-5 object-contain" />
            </a>
            ...
            <a
              ...
              className="w-10 h-10 rounded-full flex items-center justify-center hover:scale-110 transition"
            >
              <img src={wa} alt="WhatsApp" className="w-5 h-5 object-contain" />
            </a>
