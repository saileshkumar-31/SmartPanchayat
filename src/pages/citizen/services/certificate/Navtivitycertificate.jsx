...
const navigate = useNavigate();
  const documents = [
    ...
    "Parent Nativity Proof (if available)",
    "Voter ID / Residence Records",
    "Passport Size Photograph",
    "Self Declaration if required",
  ];

  const eligibility = [
    "Applicant should ordinarily belong to or be permanently settled in the state.",
    "Residence history or family origin may be verified by authority.",
    "Supporting documents should match submitted details.",
  ];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 max-w-3xl">
                Nativity Certificate is commonly used as proof of origin or
                permanent belonging to a state for admissions, employment,
                quotas, and other official purposes.
              </p>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
            ...
            <p className="text-sm text-gray-500 mt-5">
              Exact requirements may vary by district or issuing authority.
            </p>
          </div>
...
export default NativityCertificate;