...
const navigate = useNavigate();
  ...
  const documents = [
    ...
    "Wedding Invitation / Marriage Proof",
    "Marriage Photo(s)",
    "Witness Identity Proofs",
    "Address Proof",
    "Passport Size Photographs",
    "Joint Declaration / Application Form",
  ];

  const eligibility = [
    "Marriage should be legally solemnized under applicable law.",
    "Both parties should satisfy age and consent requirements.",
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 max-w-3xl">
                Marriage Certificate is an official proof of marriage used for
                passport applications, visa processing, name change, insurance,
                legal matters, and family records.
              </p>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
            ...
            <p className="text-sm text-gray-500 mt-5">
              Exact requirements may vary based on registration type and authority.
            </p>
          </div>
